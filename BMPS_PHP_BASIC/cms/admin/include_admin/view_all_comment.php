...
<?php 
        ...
        echo "<td><a href='comment.php?unaprove=$comment_id'> Unaprove<?a></td>";
...
if(isset($_GET['unaprove'])){
    ...
    $query ="UPDATE comment SET comment_status='unaprove' WHERE comment_id=$comment_id";
    $result = mysqli_query($connect,$query);
    if(!$result){
        die('Query Failed'.mysqli_error($result));
    }
