              ...
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" data-toggle="collapse" href="#componentsCollapse">
                    ...
                    <span class="sidebar-normal"> Blog
                      <b class="caret"></b>
                    </span>
                  </a>
                  <div class="collapse" id="componentsCollapse">
                    <ul class="nav">
                      <li class="nav-item ">
                        <a class="nav-link" href="../../admin/category_index.php">
                          <span class="sidebar-mini"> c </span>
                          <span class="sidebar-normal"> Category </span>
                        </a>
                      </li>
                      <li class="nav-item ">
                        <a class="nav-link" href="../../admin/category_create.php">
                          <span class="sidebar-mini"> C C </span>
                          <span class="sidebar-normal"> Category Create</span>
                        </a>
                      </li>
                    </ul>
                  </div>
